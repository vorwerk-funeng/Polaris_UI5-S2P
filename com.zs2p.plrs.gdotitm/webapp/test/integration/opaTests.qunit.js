...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/zs2p/plrs/gdotitm/test/integration/FirstJourney",
    "com/zs2p/plrs/gdotitm/test/integration/TP_ListListJourney",
    "com/zs2p/plrs/gdotitm/test/integration/TP_ListObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
