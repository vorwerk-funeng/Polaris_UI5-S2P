...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/zs2p/plrs/gdotprd/test/integration/FirstJourney",
    "com/zs2p/plrs/gdotprd/test/integration/ListListJourney",
    "com/zs2p/plrs/gdotprd/test/integration/ListObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
