...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/zs2p/plrs/mmrreport/test/integration/FirstJourney",
    "com/zs2p/plrs/mmrreport/test/integration/MMRListJourney",
    "com/zs2p/plrs/mmrreport/test/integration/MMRObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
